  ...
  class UnifiedPaymentClient
    ...
    def self.create_order(amount, options={})
      ...
      begin
        ...
        raise UnifiedPaymentError.new("Unable to send create order request to Unified Payments Ltd. ERROR: " + e.message)
      end
      ...
      if response["TKKPG"]["Response"]["Status"] == "00"
        ...
        raise UnifiedPaymentError.new("CreateOrder Failed", response)
      end
    ...
    def self.get_order_status(orderId, sessionId)
      ...
      begin
        ...
        raise UnifiedPaymentError.new("################### Unable to send get order status request to Unified Payments Ltd " + e.message)
      end
